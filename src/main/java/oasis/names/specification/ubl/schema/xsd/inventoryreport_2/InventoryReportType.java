...
import oasis.names.specification.ubl.schema.xsd.commonaggregatecomponents_2.InventoryReportLineType;
 ...
 *          
 * 
 * <p>Clase Java para InventoryReportType complex type.
 * 
 ...
 *         &lt;element ref="{urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2}RetailerCustomerParty"/&gt;
 ...
 *         &lt;element ref="{urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2}InventoryReportLine" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class InventoryReportType {
    ...
    @XmlElement(name = "RetailerCustomerParty", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", required = true)
    ...
    @XmlElement(name = "InventoryReportLine", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", required = true)
    protected List<InventoryReportLineType> inventoryReportLine;
     ...
     * </pre>
     * 
     *                Gets the value of the inventoryReportLine property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the inventoryReportLine property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getInventoryReportLine().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link InventoryReportLineType }
     * 
     * 
     */
    public List<InventoryReportLineType> getInventoryReportLine() {
        if (inventoryReportLine == null) {
            inventoryReportLine = new ArrayList<InventoryReportLineType>();
        }
