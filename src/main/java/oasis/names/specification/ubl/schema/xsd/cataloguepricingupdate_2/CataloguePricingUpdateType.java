...
import oasis.names.specification.ubl.schema.xsd.commonaggregatecomponents_2.CataloguePricingUpdateLineType;
 ...
 *          
 * 
 * <p>Clase Java para CataloguePricingUpdateType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="CataloguePricingUpdateType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element ref="{urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2}CataloguePricingUpdateLine" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "CataloguePricingUpdateType", propOrder = {
    "ublExtensions",
    "ublVersionID",
    "customizationID",
    "profileID",
...
public class CataloguePricingUpdateType {
    ...
    @XmlElement(name = "RelatedCatalogueReference", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", required = true)
    protected CatalogueReferenceType relatedCatalogueReference;
    ...
    @XmlElement(name = "DefaultLanguage", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    protected LanguageType defaultLanguage;
    @XmlElement(name = "CataloguePricingUpdateLine", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", required = true)
    protected List<CataloguePricingUpdateLineType> cataloguePricingUpdateLine;
     ...
     *     
     */
    public CatalogueReferenceType getRelatedCatalogueReference() {
        return relatedCatalogueReference;
    }

    /**
     * Define el valor de la propiedad relatedCatalogueReference.
     * 
     * @param value
     *     allowed object is
     *     {@link CatalogueReferenceType }
    ...
    public void setRelatedCatalogueReference(CatalogueReferenceType value) {
        this.relatedCatalogueReference = value;
    }
    ...
    /**
     * Define el valor de la propiedad defaultLanguage.
     * 
     * @param value
     *     allowed object is
     *     {@link LanguageType }
     ...
     * </pre>
     * 
     *                Gets the value of the cataloguePricingUpdateLine property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the cataloguePricingUpdateLine property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCataloguePricingUpdateLine().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link CataloguePricingUpdateLineType }
     * 
     * 
     */
    public List<CataloguePricingUpdateLineType> getCataloguePricingUpdateLine() {
        if (cataloguePricingUpdateLine == null) {
            cataloguePricingUpdateLine = new ArrayList<CataloguePricingUpdateLineType>();
        }
