...
package oasis.names.specification.ubl.schema.xsd.goodsitemitinerary_2;
...
import oasis.names.specification.ubl.schema.xsd.commonaggregatecomponents_2.GoodsItemType;
import oasis.names.specification.ubl.schema.xsd.commonaggregatecomponents_2.PackageType;
...
import oasis.names.specification.ubl.schema.xsd.commonaggregatecomponents_2.TransportationSegmentType;
 ...
 *          
 * 
 * <p>Clase Java para GoodsItemItineraryType complex type.
 * 
...
@XmlType(name = "GoodsItemItineraryType", propOrder = {
    "ublExtensions",
    "ublVersionID",
    "customizationID",
    "profileID",
...
public class GoodsItemItineraryType {
    ...
    @XmlElement(name = "ReferencedTransportEquipment", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    protected List<TransportEquipmentType> referencedTransportEquipment;
    @XmlElement(name = "ReferencedPackage", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    protected List<PackageType> referencedPackage;
    @XmlElement(name = "ReferencedGoodsItem", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    protected List<GoodsItemType> referencedGoodsItem;
    @XmlElement(name = "TransportationSegment", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", required = true)
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the referencedConsignment property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * 
     */
    public List<ConsignmentType> getReferencedConsignment() {
        if (referencedConsignment == null) {
            referencedConsignment = new ArrayList<ConsignmentType>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the referencedTransportEquipment property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<TransportEquipmentType> getReferencedTransportEquipment() {
        if (referencedTransportEquipment == null) {
            referencedTransportEquipment = new ArrayList<TransportEquipmentType>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the referencedPackage property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<PackageType> getReferencedPackage() {
        if (referencedPackage == null) {
            referencedPackage = new ArrayList<PackageType>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the referencedGoodsItem property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<GoodsItemType> getReferencedGoodsItem() {
        if (referencedGoodsItem == null) {
            referencedGoodsItem = new ArrayList<GoodsItemType>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the transportationSegment property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link TransportationSegmentType }
     * 
     * 
     */
    public List<TransportationSegmentType> getTransportationSegment() {
        if (transportationSegment == null) {
            transportationSegment = new ArrayList<TransportationSegmentType>();
        }
