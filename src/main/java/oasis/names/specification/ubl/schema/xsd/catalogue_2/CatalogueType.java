...
import oasis.names.specification.ubl.schema.xsd.commonaggregatecomponents_2.CatalogueLineType;
 ...
 *          
 * 
 * <p>Clase Java para CatalogueType complex type.
 * 
...
public class CatalogueType {
    ...
    @XmlElement(name = "SourceCatalogueReference", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    ...
    /**
     * Define el valor de la propiedad sourceCatalogueReference.
     * 
     * @param value
     *     allowed object is
     *     {@link CatalogueReferenceType }
    ...
    public void setSourceCatalogueReference(CatalogueReferenceType value) {
        this.sourceCatalogueReference = value;
    }
