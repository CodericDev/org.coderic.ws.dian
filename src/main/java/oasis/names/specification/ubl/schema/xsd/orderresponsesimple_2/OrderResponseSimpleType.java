...
package oasis.names.specification.ubl.schema.xsd.orderresponsesimple_2;
 ...
 *          
 * 
 * <p>Clase Java para OrderResponseSimpleType complex type.
 * 
 ...
 *         &lt;element ref="{urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2}RejectionNote" maxOccurs="unbounded" minOccurs="0"/&gt;
...
public class OrderResponseSimpleType {
    ...
    @XmlElement(name = "AcceptedIndicator", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2", required = true)
    protected AcceptedIndicatorType acceptedIndicator;
    @XmlElement(name = "RejectionNote", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")
    protected List<RejectionNoteType> rejectionNote;
     ...
     * @return
     *     possible object is
     *     {@link AcceptedIndicatorType }
     *     
     */
    public AcceptedIndicatorType getAcceptedIndicator() {
        return acceptedIndicator;
    }

    /**
     * Define el valor de la propiedad acceptedIndicator.
     * 
     * @param value
     *     allowed object is
     *     {@link AcceptedIndicatorType }
     *     
     */
    public void setAcceptedIndicator(AcceptedIndicatorType value) {
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the rejectionNote property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRejectionNote().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link RejectionNoteType }
     * 
     * 
     */
    public List<RejectionNoteType> getRejectionNote() {
        if (rejectionNote == null) {
            rejectionNote = new ArrayList<RejectionNoteType>();
        }
