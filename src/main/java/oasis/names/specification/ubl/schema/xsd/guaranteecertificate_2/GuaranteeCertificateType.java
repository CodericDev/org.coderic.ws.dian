...
package oasis.names.specification.ubl.schema.xsd.guaranteecertificate_2;
...
import oasis.names.specification.ubl.schema.xsd.commonaggregatecomponents_2.ImmobilizedSecurityType;
import oasis.names.specification.ubl.schema.xsd.commonaggregatecomponents_2.PartyType;
import oasis.names.specification.ubl.schema.xsd.commonaggregatecomponents_2.PeriodType;
import oasis.names.specification.ubl.schema.xsd.commonaggregatecomponents_2.RegulationType;
 ...
 *          
 * 
 * <p>Clase Java para GuaranteeCertificateType complex type.
 * 
...
@XmlType(name = "GuaranteeCertificateType", propOrder = {
    "ublExtensions",
    "ublVersionID",
    "customizationID",
    "profileID",
...
public class GuaranteeCertificateType {
    ...
    @XmlElement(name = "GuaranteeTypeCode", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")
    ...
    @XmlElement(name = "LiabilityAmount", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2", required = true)
    protected LiabilityAmountType liabilityAmount;
    @XmlElement(name = "ConstitutionCode", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")
    ...
    @XmlElement(name = "ApplicableRegulation", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    protected List<RegulationType> applicableRegulation;
    @XmlElement(name = "GuaranteeDocumentReference", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    protected List<DocumentReferenceType> guaranteeDocumentReference;
    @XmlElement(name = "ImmobilizedSecurity", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    ...
    @XmlElement(name = "GuarantorParty", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", required = true)
    protected PartyType guarantorParty;
    @XmlElement(name = "InterestedParty", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", required = true)
    protected PartyType interestedParty;
    @XmlElement(name = "BeneficiaryParty", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    ...
    /**
     * Define el valor de la propiedad constitutionCode.
     * 
     * @param value
     *     allowed object is
     *     {@link ConstitutionCodeType }
    ...
    /**
     * Define el valor de la propiedad applicablePeriod.
     * 
     * @param value
     *     allowed object is
     *     {@link PeriodType }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the applicableRegulation property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<RegulationType> getApplicableRegulation() {
        if (applicableRegulation == null) {
            applicableRegulation = new ArrayList<RegulationType>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the guaranteeDocumentReference property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
    ...
    public List<DocumentReferenceType> getGuaranteeDocumentReference() {
        if (guaranteeDocumentReference == null) {
            guaranteeDocumentReference = new ArrayList<DocumentReferenceType>();
        }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the immobilizedSecurity property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ImmobilizedSecurityType }
     * 
     * 
     */
    public List<ImmobilizedSecurityType> getImmobilizedSecurity() {
        if (immobilizedSecurity == null) {
            immobilizedSecurity = new ArrayList<ImmobilizedSecurityType>();
        }
    ...
    /**
     * Define el valor de la propiedad guarantorParty.
     * 
     * @param value
     *     allowed object is
     *     {@link PartyType }
    ...
    /**
     * Define el valor de la propiedad interestedParty.
     * 
     * @param value
     *     allowed object is
     *     {@link PartyType }
    ...
    /**
     * Define el valor de la propiedad beneficiaryParty.
     * 
     * @param value
     *     allowed object is
     *     {@link PartyType }
     *     
     */
    public void setBeneficiaryParty(PartyType value) {
