...
package oasis.names.specification.ubl.schema.xsd.forecastrevision_2;
...
import oasis.names.specification.ubl.schema.xsd.commonaggregatecomponents_2.ForecastRevisionLineType;
 ...
 *          
 * 
 * <p>Clase Java para ForecastRevisionType complex type.
 * 
...
@XmlType(name = "ForecastRevisionType", propOrder = {
    "ublExtensions",
    "ublVersionID",
    "customizationID",
    "profileID",
...
public class ForecastRevisionType {
    ...
    @XmlElement(name = "RevisionStatusCode", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")
    ...
    @XmlElement(name = "ForecastRevisionLine", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", required = true)
     ...
     * @return
     *     possible object is
     *     {@link RevisionStatusCodeType }
     *     
     */
    public RevisionStatusCodeType getRevisionStatusCode() {
        return revisionStatusCode;
    }

    /**
     * Define el valor de la propiedad revisionStatusCode.
     * 
     * @param value
     *     allowed object is
     *     {@link RevisionStatusCodeType }
     *     
     */
    public void setRevisionStatusCode(RevisionStatusCodeType value) {
        this.revisionStatusCode = value;
    }
    ...
    /**
     * Define el valor de la propiedad purposeCode.
     * 
     * @param value
     *     allowed object is
     *     {@link PurposeCodeType }
     ...
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the forecastRevisionLine property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ForecastRevisionLineType }
     * 
     * 
     */
    public List<ForecastRevisionLineType> getForecastRevisionLine() {
        if (forecastRevisionLine == null) {
            forecastRevisionLine = new ArrayList<ForecastRevisionLineType>();
        }
