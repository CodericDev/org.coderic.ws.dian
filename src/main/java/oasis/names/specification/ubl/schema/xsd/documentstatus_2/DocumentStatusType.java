 ...
 *          
 * 
 * <p>Clase Java para DocumentStatusType complex type.
 * 
 ...
 *         &lt;element ref="{urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2}DocumentResponse" minOccurs="0"/&gt;
 *         &lt;element ref="{urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2}AdditionalDocumentResponse" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class DocumentStatusType {
    ...
    protected DocumentResponseType documentResponse;
    @XmlElement(name = "AdditionalDocumentResponse", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    protected List<DocumentResponseType> additionalDocumentResponse;
     ...
     *     
     */
    public DocumentResponseType getDocumentResponse() {
     ...
     *     
     */
    public void setDocumentResponse(DocumentResponseType value) {
     ...
     * </pre>
     * 
     *                Gets the value of the additionalDocumentResponse property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the additionalDocumentResponse property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAdditionalDocumentResponse().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<DocumentResponseType> getAdditionalDocumentResponse() {
        if (additionalDocumentResponse == null) {
            additionalDocumentResponse = new ArrayList<DocumentResponseType>();
        }
