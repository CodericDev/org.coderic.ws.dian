...
package oasis.names.specification.ubl.schema.xsd.requestforquotation_2;
...
import oasis.names.specification.ubl.schema.xsd.commonaggregatecomponents_2.RequestForQuotationLineType;
 ...
 *          
 * 
 * <p>Clase Java para RequestForQuotationType complex type.
 * 
 ...
 *         &lt;element ref="{urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2}SubmissionDueDate" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2}RequestedValidityPeriod" minOccurs="0"/&gt;
...
public class RequestForQuotationType {
    ...
    @XmlElement(name = "SubmissionDueDate", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")
    protected SubmissionDueDateType submissionDueDate;
    ...
    @XmlElement(name = "RequestedValidityPeriod", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    protected PeriodType requestedValidityPeriod;
     ...
     * @return
     *     possible object is
     *     {@link SubmissionDueDateType }
     *     
     */
    public SubmissionDueDateType getSubmissionDueDate() {
        return submissionDueDate;
    }

    /**
     * Define el valor de la propiedad submissionDueDate.
     * 
     * @param value
     *     allowed object is
     *     {@link SubmissionDueDateType }
     *     
     */
    public void setSubmissionDueDate(SubmissionDueDateType value) {
     ...
     *     
     */
    public PeriodType getRequestedValidityPeriod() {
        return requestedValidityPeriod;
    }

    /**
     * Define el valor de la propiedad requestedValidityPeriod.
     * 
     * @param value
     *     allowed object is
     *     {@link PeriodType }
     *     
     */
    public void setRequestedValidityPeriod(PeriodType value) {
        this.requestedValidityPeriod = value;
    }
    ...
    /**
     * Define el valor de la propiedad destinationCountry.
     * 
     * @param value
     *     allowed object is
     *     {@link CountryType }
