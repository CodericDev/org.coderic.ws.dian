...
import oasis.names.specification.ubl.schema.xsd.commonaggregatecomponents_2.StatementLineType;
 ...
 *          
 * 
 * <p>Clase Java para StatementType complex type.
 * 
...
public class StatementType {
    ...
    @XmlElement(name = "TotalBalanceAmount", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")
    ...
    @XmlElement(name = "StatementTypeCode", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")
    protected StatementTypeCodeType statementTypeCode;
    @XmlElement(name = "StatementPeriod", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2")
    ...
    @XmlElement(name = "StatementLine", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", required = true)
    ...
    /**
     * Define el valor de la propiedad totalBalanceAmount.
     * 
     * @param value
     *     allowed object is
     *     {@link TotalBalanceAmountType }
    ...
    /**
     * Define el valor de la propiedad statementTypeCode.
     * 
     * @param value
     *     allowed object is
     *     {@link StatementTypeCodeType }
    ...
    /**
     * Define el valor de la propiedad statementPeriod.
     * 
     * @param value
     *     allowed object is
     *     {@link PeriodType }
