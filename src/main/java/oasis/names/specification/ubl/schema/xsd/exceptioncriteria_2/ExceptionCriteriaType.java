...
package oasis.names.specification.ubl.schema.xsd.exceptioncriteria_2;
...
import oasis.names.specification.ubl.schema.xsd.commonaggregatecomponents_2.ExceptionCriteriaLineType;
 ...
 *          
 * 
 * <p>Clase Java para ExceptionCriteriaType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ExceptionCriteriaType"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element ref="{urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2}ValidityPeriod"/&gt;
 ...
 *         &lt;element ref="{urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2}ExceptionCriteriaLine" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ExceptionCriteriaType", propOrder = {
    "ublExtensions",
    "ublVersionID",
    "customizationID",
    "profileID",
...
public class ExceptionCriteriaType {
    ...
    @XmlElement(name = "ValidityPeriod", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", required = true)
    ...
    @XmlElement(name = "ExceptionCriteriaLine", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", required = true)
    protected List<ExceptionCriteriaLineType> exceptionCriteriaLine;
     ...
     * </pre>
     * 
     *                Gets the value of the exceptionCriteriaLine property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the exceptionCriteriaLine property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getExceptionCriteriaLine().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ExceptionCriteriaLineType }
     * 
     * 
     */
    public List<ExceptionCriteriaLineType> getExceptionCriteriaLine() {
        if (exceptionCriteriaLine == null) {
            exceptionCriteriaLine = new ArrayList<ExceptionCriteriaLineType>();
        }
