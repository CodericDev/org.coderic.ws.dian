...
package oasis.names.specification.ubl.schema.xsd.forecast_2;
...
import oasis.names.specification.ubl.schema.xsd.commonaggregatecomponents_2.ForecastLineType;
 ...
 *          
 * 
 * <p>Clase Java para ForecastType complex type.
 * 
 ...
 *         &lt;element ref="{urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2}BasedOnConsensusIndicator" minOccurs="0"/&gt;
 ...
 *         &lt;element ref="{urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2}ForecastLine" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ForecastType {
    ...
    @XmlElement(name = "BasedOnConsensusIndicator", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2")
    protected BasedOnConsensusIndicatorType basedOnConsensusIndicator;
    ...
    @XmlElement(name = "ForecastPeriod", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", required = true)
    ...
    @XmlElement(name = "ForecastLine", namespace = "urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2", required = true)
    protected List<ForecastLineType> forecastLine;
     ...
     * @return
     *     possible object is
     *     {@link BasedOnConsensusIndicatorType }
     *     
     */
    public BasedOnConsensusIndicatorType getBasedOnConsensusIndicator() {
        return basedOnConsensusIndicator;
    }

    /**
     * Define el valor de la propiedad basedOnConsensusIndicator.
     * 
     * @param value
     *     allowed object is
     *     {@link BasedOnConsensusIndicatorType }
     *     
     */
    public void setBasedOnConsensusIndicator(BasedOnConsensusIndicatorType value) {
        this.basedOnConsensusIndicator = value;
    }
     ...
     * </pre>
     * 
     *                Gets the value of the forecastLine property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the forecastLine property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getForecastLine().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ForecastLineType }
     * 
     * 
     */
    public List<ForecastLineType> getForecastLine() {
        if (forecastLine == null) {
            forecastLine = new ArrayList<ForecastLineType>();
        }
