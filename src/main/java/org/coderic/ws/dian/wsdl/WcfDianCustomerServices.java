 ...
 * 
 */
@WebServiceClient(name = "WcfDianCustomerServices", targetNamespace = "http://wcf.dian.colombia", wsdlLocation = "file:/home/neftaliyagua/dev/CodericBusiness/org.coderic.ws.dian/src/main/wsdl/WcfDianCustomerServices.wsdl")
public class WcfDianCustomerServices
    extends Service
{

    private final static URL WCFDIANCUSTOMERSERVICES_WSDL_LOCATION;
    private final static WebServiceException WCFDIANCUSTOMERSERVICES_EXCEPTION;
    private final static QName WCFDIANCUSTOMERSERVICES_QNAME = new QName("http://wcf.dian.colombia", "WcfDianCustomerServices");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/home/neftaliyagua/dev/CodericBusiness/org.coderic.ws.dian/src/main/wsdl/WcfDianCustomerServices.wsdl");
