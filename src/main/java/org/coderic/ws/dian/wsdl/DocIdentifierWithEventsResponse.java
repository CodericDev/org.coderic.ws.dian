...
/**
 * <p>Clase Java para DocIdentifierWithEventsResponse complex type.</p>
 * 
...
@XmlType(name = "DocIdentifierWithEventsResponse", namespace = "http://schemas.datacontract.org/2004/07/DocIdentifierWithEventsResponse", propOrder = {
    "csvBase64Bytes",
    "message",
    "statusCode",
    "success"
...
public class DocIdentifierWithEventsResponse {
    ...
    @XmlElementRef(name = "CsvBase64Bytes", namespace = "http://schemas.datacontract.org/2004/07/DocIdentifierWithEventsResponse", type = JAXBElement.class, required = false)
    protected JAXBElement<byte[]> csvBase64Bytes;
    @XmlElementRef(name = "Message", namespace = "http://schemas.datacontract.org/2004/07/DocIdentifierWithEventsResponse", type = JAXBElement.class, required = false)
    protected JAXBElement<String> message;
    @XmlElementRef(name = "StatusCode", namespace = "http://schemas.datacontract.org/2004/07/DocIdentifierWithEventsResponse", type = JAXBElement.class, required = false)
